...
servicegroup *add_servicegroup(char *,char *,double);                                                   /* adds a servicegroup definition */
...
service * enum_services(char *,service *);                                                      /* enumerates all service objects for a host */
