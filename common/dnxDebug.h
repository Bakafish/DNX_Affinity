...
# define DNX_PT_MUTEX_LOCK_CHECK(mp) { \
...
# define DNX_PT_MUTEX_UNLOCK_CHECK(mp) { \
...
# define DNX_PT_MUTEX_LOCK_CHECK(mp)      pthread_mutex_lock(mp)
# define DNX_PT_MUTEX_UNLOCK_CHECK(mp)    pthread_mutex_unlock(mp)
